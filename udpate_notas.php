  ...
  <div class="col-lg-3">
    <div class="card  text-center  ">
      ...
      <div class="card-body ">
        ...
        <form method="GET" action="vistas/update_notas_parcial.php">
           <select  id="parcial" class="form-control form-control-sm" name="parcial"  >
          <option value="A"> Seleccione ... </option>
        <?php
          $sql2="SELECT codigo_parcial, fk_periodo, parcial from parciales where estado='1'";
