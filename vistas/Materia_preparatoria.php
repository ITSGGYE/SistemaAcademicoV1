 ...
 <div class="col-lg-12">
				<div class="card text-left ">
					...
					<div class="card-body text-right">
						...
						<a href="Detalle_Materia_Preparatoria.php" class="btn btn-danger "  >
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnAgregarnuevo').click(function(){
			...
			$.ajax({
				url:"../procesos/Materia/agregaMateriaPreparatoria.php",
					type: "post",
					dataType: "html",
					data: formData,
					cache: false,
				...
				success:function(r){
					...
					if(r==1){
						...
						$('#tablaDatatable').load('Materia/tablaMateriaPreparatoria.php');
		...
		$('#btnActualizar').click(function(){
			...
			$.ajax({
					url:"../procesos/Materia/actualizaMateriaPreparatoria.php",
					type: "post",
					dataType: "html",
					data: formData,
					cache: false,
...
<script type="text/javascript">
	function agregaFrmActualizar(id_materia){
		$.ajax({
			...
			url:"../procesos/Materia/obtenDatosMateriaPreparatoria.php",
			success:function(r){
	...
	function eliminarDatos(id_materia){
		alertify.confirm('Eliminar la Asignaturas', '¿Seguro de eliminar la Asignaturas :(?', function(){ 
			...
			$.ajax({
				type:"POST",
				data:"id_materia=" + id_materia,
				url:"../procesos/Materia/eliminarMateriaPreparatoria.php",
				success:function(r){
