...
<div class="row">
    ...
    <div class="form-group col-md-10" style="margin-top: 15px; margin-left: 15px;">
     ...
     <select class="form-control form-control-sm" id="materia" name="materia">
							...
							<?php
							$sql2="SELECT id_materia, nombre_materia from materia_preparatoria  ";
    ...
    <div class="row">
     <div class="form-group col-md-10" style="margin-top: 15px; margin-left: 15px;">
      <label >Detalle de Materia</label>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#tabladatatable').load("Materia/tabladetallemateriapreparatoria.php");
		...
		$.ajax({
			type:"POST",
			data:datos,
			url:"../procesos/Materia/agregadetallemateriapreparatoria.php",
			success:function(r){
				alert(r);
				if(r){
					$("#frmingreso")[0].reset();
...
<script type="text/javascript">
		$(document).ready(function(){
			$('#btnActualizar').click(function(){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"../procesos/Materia/actualizadetallemateriapreparatoria.php",
					success:function(r){
	...
	<script type="text/javascript">
		...
		$.ajax({
			type:"POST",
			data:"id=" + id,
			url:"../procesos/Materia/ObtenDatosdetallemateriapreparatoria.php",
			success:function(r){
		...
		function eliminar(id){
			alertify.confirm('Eliminar datos de la materia','¿Desea eliminar ?', function(){ 
				$.ajax({
					type:"POST",
					data:"id=" + id,
					url:"../procesos/Materia/eliminardetallemateriapreparatoria.php",
					success:function(r){
