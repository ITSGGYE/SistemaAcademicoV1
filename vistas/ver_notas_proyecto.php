...
?>
					...
					<table class="table   table-sm table-bordered "  style="text-align: center; width: 60%; margin-left: 20%;">
						<tr>
							...
							<th > <p > <br> <br> Proyecto Escolar </td>
						...
						<?php 
						$sql="SELECT a.id_alumno ,a.nombre_Alumno , c.nota from alumno a , proyecto_escolar c where a.id_alumno=c.fk_alumno and c.fk_profesor='$profesor'  and c.fk_curso='$curso' and c.fk_parcial='$parcial' ";
						$result=mysqli_query($conexion,$sql);
						while($mostrar=mysqli_fetch_row($result)){
