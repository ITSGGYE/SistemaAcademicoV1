...
$sql="SELECT  n.id_notas, dm.actividad, n.parcial1, n.parcial2,n.parcial3, n.examen, n.promedio  FROM  detalle_materia_preparatoria dm , notas_preparatoria n 
...
<center>
	...
	<script type="text/javascript">
			...
			$.ajax({
					url:"../procesos/Calificaciones/updatenotaspreparatoria.php",
					type: "post",
					dataType: "html",
					data: formData,
					cache: false,
