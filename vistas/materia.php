 ...
 <div class="col-lg-12">
				<div class="card text-left ">
					...
					<div class="card-body text-right">
						...
						<a href="Materia_inicial2.php" class="btn btn-success "  >
							Inicial2 <span class="fa fa-plus-circle"></span> </a>
						<a href="Materia_preparatoria.php" class="btn btn-warning "  >
							Preparatoria <span class="fa fa-plus-circle"></span> </a>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#btnAgregarnuevo').click(function(){
			...
			$.ajax({
				url:"../procesos/Materia/agregaMateria.php",
					type: "post",
					dataType: "html",
					data: formData,
					cache: false,
				...
				success:function(r){
					...
					if(r==1){
						...
						$('#tablaDatatable').load('Materia/tablaMateria.php');
		...
		$('#btnActualizar').click(function(){
			...
			$.ajax({
					url:"../procesos/Materia/actualizaMateria.php",
					type: "post",
					dataType: "html",
					data: formData,
					cache: false,
...
<script type="text/javascript">
	function agregaFrmActualizar(id_materia){
		$.ajax({
			...
			url:"../procesos/Materia/obtenDatosMateria.php",
			success:function(r){
	...
	function eliminarDatos(id_materia){
		alertify.confirm('Eliminar la Asignaturas', '¿Seguro de eliminar la Asignaturas :(?', function(){ 
			...
			$.ajax({
				type:"POST",
				data:"id_materia=" + id_materia,
				url:"../procesos/Materia/eliminarMateria.php",
				success:function(r){
