...
?>
					...
					<table class="table   table-sm table-bordered "  style="text-align: center; width: 60%; margin-left: 20%;">
						...
						<?php 
						$sql="SELECT a.id_alumno ,a.nombre_Alumno , ast.fj, ast.fi, ast.fa from alumno a , asistencia ast where a.id_alumno=ast.fk_alumno and 
						ast.fk_profesor='$profesor'  and ast.fk_curso='$curso' and ast.fk_parcial='$parcial' ";
						$result=mysqli_query($conexion,$sql);
						while($mostrar=mysqli_fetch_row($result)){
