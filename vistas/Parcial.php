...
<?php require_once "../clases/conexion.php"; 
    ...
    <div class="form-group col-md-6" style="margin-top: 15px;">
      <label >Parcial</label>
      <input type="text" class="form-control form-control-sm " id="parcial" name="parcial">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#tabladatatable').load("ParcialesPeriodos/tablaParcial.php");
		...
		$.ajax({
			type:"POST",
			data:datos,
			url:"../procesos/ParcialesPeriodos/agregarparcial.php",
			success:function(r){
				
				if(r==1){
					$("#frmsistema")[0].reset();
					$('#tabladatatable').load("ParcialesPeriodos/tablaParcial.php");
					alertify.success("Parcial agregado :D");
				}else{
