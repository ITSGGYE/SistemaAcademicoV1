...
?>
	...
	<tr> <td colspan="6" align="center"> <font color="blue"><b> <?php echo mb_strtoupper($preparatoria[$i]['materia']);?> </b></td>

		</tr>
<?php
	$id=$preparatoria[$i]['id'];

$sql="SELECT  dm.actividad, n.parcial1, n.parcial2,n.parcial3, n.examen, n.promedio  FROM  detalle_materia_preparatoria dm , notas_preparatoria n 
...
<div style="width: 63%; margin-left: 410px;" >
