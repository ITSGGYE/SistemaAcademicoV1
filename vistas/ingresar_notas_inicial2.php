...
$sql="SELECT dm.id_detalle_materia, dm.actividad  FROM  detalle_materia_inicial dm where dm.fk_materia='$id'";
$result=mysqli_query($conexion,$sql);
while ($mostrar=mysqli_fetch_row($result)) {
	# code...
...
<script type="text/javascript">
		jQuery(document).on('submit','#notas',function(event){
			...
			jQuery.ajax({
				url:"../procesos/Calificaciones/ingresonotasinicial2.php",
				type: 'POST',
				dataType:'json',
				data:$(this).serialize(),
			})
