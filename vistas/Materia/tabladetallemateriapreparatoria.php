...
$sql="SELECT dm.id_detalle_materia, m.nombre_materia, dm.actividad, dm.estado  FROM materia_preparatoria m , detalle_materia_preparatoria dm where dm.fk_materia=m.id_materia";
