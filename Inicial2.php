...
<tr>
  ...
  <td> <a href="vistas/ver_notas_inicial2.php?alumno=<?php echo $mostrar[0]?>&periodo=<?php echo $periodo ?>&curso=<?php echo $curso?>&anio=<?php echo $mostrar[2] ?>&profesor=<?php echo $profesor?>"" class="btn btn-success btn-sm">
             Ver  <span class="glyphicon glyphicon-list-alt"></span>
            </a></td>
  <td> <a href="vistas/ingresar_notas_inicial2.php?alumno=<?php echo $mostrar[0]?>&periodo=<?php echo $periodo ?>&curso=<?php echo $curso?>&anio=<?php echo $mostrar[2] ?>" class="btn btn-primary btn-sm">
              Calificar  <span class="glyphicon glyphicon-list-alt"></span>
            </a></td>
  <td> <a href="vistas/update_notas_inicial2.php?alumno=<?php echo $mostrar[0]?>&periodo=<?php echo $periodo ?>&curso=<?php echo $curso?>&anio=<?php echo $mostrar[2] ?>" class="btn btn-warning btn-sm">
